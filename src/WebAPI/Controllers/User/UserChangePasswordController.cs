...
public class UserChangePasswordController : AuthorizeBaseController
{
    private readonly IUpdateUserPassword _updateUserPassword;
    public UserChangePasswordController(IUpdateUserPassword updateUserPassword,ITokenServices token) : base(token)
    {
    ...
    {
       var result = await _updateUserPassword.UpdateUserPassowrdAsync(User, request);
